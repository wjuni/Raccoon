bootstrap.js:11: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:28: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:88: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:183: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:309: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:446: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
      $next[0].offsetWidth; // force reflow
      ^^^^^^^^^^^^^^^^^^^^

bootstrap.js:548: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:643: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
    this.$element[dimension](this.$element[dimension]())[0].offsetHeight;
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

bootstrap.js:760: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:926: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:1005: WARNING - Suspicious code. This code lacks side-effects. Is there a bug?
      if (transition) {
      ^^^^^^^^^^^^^^^^^

bootstrap.js:1006: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
        that.$element[0].offsetWidth // force reflow
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^

bootstrap.js:1123: WARNING - Suspicious code. This code lacks side-effects. Is there a bug?
      if (doAnimate) this.$backdrop[0].offsetWidth; // force reflow
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

bootstrap.js:1123: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
      if (doAnimate) this.$backdrop[0].offsetWidth; // force reflow
                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

bootstrap.js:1267: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:1787: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:1896: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:2069: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^

bootstrap.js:2146: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
        element[0].offsetWidth; // reflow for transition
        ^^^^^^^^^^^^^^^^^^^^^^

bootstrap.js:2225: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^^^^^^^^^^^^^^^
