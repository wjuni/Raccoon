...
null);"Distance"===a.html()&&g()});b("#opt_dist_num").on("change",g);p=function(a){b("#btn_status").html(a.status+" (Ver "+a.ver+" / GPS:"+a.gps+")")}}var e,r="Nonstop",q=!1,v=new naver.maps.LatLng(36.373465,127.359998),h=null,d=null,f=null,k=null,l=!0,p=function(){},t=!0,m=!1;b(document).ready(function(){function g(n){n.matches?a():(b(".menu_background").addClass("hidden"),n=b(".sidebar"),n.css("left","0"),n.css("width","240px"),m=!1)}function a(){if(d.matches){b(".menu_background").addClass("hidden");
var a=b(".sidebar");a.css("width","0");a.css("left","-240px");m=!1}}u("naver-map");b(".left_menu").on("click",function(){location.reload()});if("onhashchange"in window)window.onhashchange=function(){console.log(window.location.hash);location.reload()};else{var c=window.location.hash;window.setInterval(function(){window.location.hash!==c&&(c=window.location.hash,console.log(c),location.reload())},100)}var d=window.matchMedia("(max-width: 1170px)");d.addListener(g);g(d);b(".menu_background").click(a);
b(".logo-a").click(function(){if(m)a();else if(d.matches){var c=b(".sidebar");c.css("width","240px");c.css("transition",".3s ease-in");b(".menu_background").removeClass("hidden");c.css("left","0");m=!0}});var f=window.location.hash.substr(1);""===f&&(location.replace("#dashboard"),location.reload());"dashboard"===f?w():"control"===f&&x();b.post("ajax/fetch_dashboard.php",function(a){JSON.parse(a)});setInterval(function(){b.post("ajax/fetch_dashboard.php",function(a){a=JSON.parse(a);p(a);0<a.lat&&
0<a.lng?(h=new naver.maps.LatLng(a.lat,a.lng),l&&e.setCenter(h),null===k?(a={position:h,map:e,icon:{url:"images/current_location.png",size:new naver.maps.Size(80,80),origin:new naver.maps.Point(0,0),anchor:new naver.maps.Point(8,8),scaledSize:new naver.maps.Size(16,16)}},k=new naver.maps.Marker(a),l=!0,b("#btn_current_loc").removeClass("grayscale")):k.setPosition(h)):(null!==k&&(k.setMap(null),k=null),h=null)})},1E3)})});
